...
- [ ] Scopes are minimal: read_products.
- [ ] Missing permissions produce useful UI.
- [ ] Billing is either disabled or uses Shopify Billing API with test plan.
- [ ] Webhooks configured and verified: app/uninstalled, app/scopes_update, products/update.
...
- [ ] Known limitation disclosed: MVP is visual and Admin-first App Home; future product update webhooks.
