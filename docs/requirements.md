...
- FR-002: El dashboard debe mostrar estado general, metricas y cola principal de identifier issue.
- FR-003: La pantalla Identifier audit debe mostrar datos de ejemplo, prioridades, acciones visuales y limites del MVP.
- FR-004: La pantalla Guardrails debe validar server-side workflowName, ownerEmail y threshold.
